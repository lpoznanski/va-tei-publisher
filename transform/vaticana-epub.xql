...
module namespace model="http://www.tei-c.org/pm/models/vaticana/epub";
    ...
    $input !         (
            ...
            return
                    ...
                    case element(settlement) return
                        epub:alternate($config, ., ("tei-settlement", css:map-rend-to-class(.)), ., ., .)
                    ...
                    case element(measure) return
                        epub:alternate($config, ., ("tei-measure", css:map-rend-to-class(.)), ., ., concat('Jednostka: ', @unit, ', Ilość: ', @quantity, ', Szczegóły: ', @commodity))
                    case element(orgName) return
                        epub:alternate($config, ., ("tei-orgName", css:map-rend-to-class(.)), ., ., .)
                    ...
                    case element(education) return
                        epub:alternate($config, ., ("tei-education", css:map-rend-to-class(.)), ., ., @subtype)
