            ...
            return
                    ...
                    case element(title) return
                        if ($parameters?header='document') then
                            epub:block($config, ., ("tei-title1", css:map-rend-to-class(.)), .)
                        else
                            if ($parameters?header='short') then
                    ...
                    case element(titleStmt) return
                        if ($parameters?mode='title') then
                            ...
                            if ($parameters?header='short') then
                                ...
                                if ($parameters?header='document') then
                                    (
                                        epub:block($config, ., ("tei-titleStmt8", css:map-rend-to-class(.)), title[1]),
                                        epub:block($config, ., ("tei-titleStmt9", css:map-rend-to-class(.)), subsequence(title, 2)),
                                        epub:block($config, ., ("tei-titleStmt10", css:map-rend-to-class(.)), ../publicationStmt/substring-after(idno, "Item:")),
                                        epub:block($config, ., ("tei-titleStmt11", css:map-rend-to-class(.)), root(.)//profileDesc/abstract)
                                    )

                                else
                                    epub:block($config, ., ("tei-titleStmt12", css:map-rend-to-class(.)), ../fileDesc/titleStmt/title)
