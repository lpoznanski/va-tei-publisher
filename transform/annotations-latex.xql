    ...
    $input !         (
            ...
            return
                    ...
                    case element(note) return
                        latex:inline($config, ., ("tei-note1", "annotation", "annotation-note", css:map-rend-to-class(.)), .)
                    ...
                    case element(add) return
                        latex:inline($config, ., ("tei-add", "annotation", "annotation-add", "authority", css:map-rend-to-class(.)), .)
                    ...
                    case element(title) return
                        if ($parameters?header='document') then
                            latex:block($config, ., ("tei-title1", css:map-rend-to-class(.)), .)
                        else
                            if ($parameters?header='short') then
                    ...
                    case element(settlement) return
                        latex:inline($config, ., ("tei-settlement", "annotation", "annotation-settlement", "authority", css:map-rend-to-class(.)), .)
                    case element(affiliation) return
                        latex:inline($config, ., ("tei-affiliation", "annotation", "annotation-affiliation", "authority", css:map-rend-to-class(.)), .)
                    case element(roleName) return
                        latex:inline($config, ., ("tei-roleName", "annotation", "annotation-role", "authority", css:map-rend-to-class(.)), .)
                    case element(measure) return
                        latex:inline($config, ., ("tei-measure", "annotation", "annotation-measure", "authority", css:map-rend-to-class(.)), .)
                    case element(education) return
                        latex:inline($config, ., ("tei-education", "annotation", "annotation-education", "authority", css:map-rend-to-class(.)), .)
                    case element(country) return
                        latex:inline($config, ., ("tei-country", "annotation", "annotation-country", "authority", css:map-rend-to-class(.)), .)
                    case element(region) return
                        latex:inline($config, ., ("tei-region", "annotation", "annotation-region", "authority", css:map-rend-to-class(.)), .)
                    case element(state) return
                        latex:inline($config, ., ("tei-state", "annotation", "annotation-state", "authority", css:map-rend-to-class(.)), .)
                    case element() return
